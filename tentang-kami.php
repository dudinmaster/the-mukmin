                    ...
                    <div class="col-lg-7">
                        <div class="hero-header-inner animated zoomIn">
                            ...
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item text-dark" aria-current="page">Tentang Kami</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5">
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-xl-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <h1 class="display-5 pb-4 m-0">Tujuan THEMukmin</h1>
                        <p class="pb-4">Tujuan THEMukmin adalan untuk mereka mencari doa maupun dzikir yang akan mempengaruhi hidup mereka, dan juga menambah ilmu bagi para pembaca, terutama bagi mereka yang mudah putus asa, sekeras apapun kamu berusaha jangan lupa berdoa, janji Allah itu benar.</p>
